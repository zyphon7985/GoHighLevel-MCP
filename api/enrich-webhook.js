...
B) icp_score_d2d (DOOR-TO-DOOR, 0-100, geo-dominant)
   ...
   Layer 2 — business-type multiplier (apply to base_fit before adding drive points; clamp to 0-65):
     ...
     0.60x  Production homebuilder (mid-to-large family-owned, 50-300 employees REQUIRED, regional single-state multi-community footprint) — bigger than sweet-spot but still field-heavy and owner/principal accessible. HARD GATE: do not apply 0.60x unless the company already has at least 50 employees AND a multi-community footprint. A "fast-growing" or "family-owned" builder with under 50 employees is NOT 0.60x; that shape is 1.0x Mid-size residential builder. Pipelines and growth potential do not promote a sub-50-employee builder into this tier. Distinguished from Enterprise GC (0.30x) by single-state footprint and family ownership keeping the decision-maker reachable.
   ...
   MULTIPLIER DISAMBIGUATION (read this when picking the multiplier — these are the two recurring miscategorizations):
     ...
     Miscategorization 1: Fast-growing builder with low current employee count → 1.0x, NOT 0.60x.
       ...
       Correct call: 1.0x Mid-size residential builder. The 0.60x tier is reserved for companies that HAVE ALREADY grown past 50 employees. Future growth or pipeline depth does not promote a sub-50-employee builder into 0.60x.
